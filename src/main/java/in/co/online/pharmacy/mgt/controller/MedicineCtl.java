...
public class MedicineCtl extends BaseCtl {
    ...
    protected boolean validate(HttpServletRequest request) {
		log.debug("MedicineCtl validate method start");
        boolean pass = true;
        ...
        if (DataValidator.isNull(request.getParameter("catagry"))) {
            request.setAttribute("catagry",
                    PropertyReader.getValue("error.require", "Catagry"));
            pass = false;
        }
        ...
        log.debug("MedicineCtl validate method end");
		return pass;
	}
	
	@Override
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("MedicineCtl populateBean method start");
		MedicineBean bean=new MedicineBean();
		bean.setId(DataUtility.getLong(request.getParameter("id")));
		bean.setName(DataUtility.getString(request.getParameter("name")));
		bean.setPrice(DataUtility.getString(request.getParameter("price")));
		bean.setCatagry(DataUtility.getString(request.getParameter("catagry")));
		...
		log.debug("MedicineCtl populateBean method end");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("MedicineCtl doGet method start"); 
		String op = DataUtility.getString(request.getParameter("operation"));
		   ...
		   MedicineModel model = new MedicineModel();
			...
			log.debug("MedicineCtl doGet method end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("MedicineCtl doPost method start");
		String op=DataUtility.getString(request.getParameter("operation"));
		MedicineModel model=new MedicineModel();
		long id=DataUtility.getLong(request.getParameter("id"));
		...
		ServletUtility.forward(getView(), request, response);
		 log.debug("MedicineCtl doPost method end");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return OPSView.MEDICINE_VIEW;
	}
