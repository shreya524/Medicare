...
import in.co.online.pharmacy.mgt.exception.RecordNotFoundException;
import in.co.online.pharmacy.mgt.util.EmailBuilder;
import in.co.online.pharmacy.mgt.util.EmailMessage;
import in.co.online.pharmacy.mgt.util.EmailUtility;
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE P_USER SET FIRSTNAME=?,LASTNAME=?,LOGIN=?,PASSWORD=?,DOB=?,MOBILENO=?,address=?,city=?,ROLEID=?,"
