package in.co.online.pharmacy.mgt.util;
...
import in.co.online.pharmacy.mgt.controller.BaseCtl;
import in.co.online.pharmacy.mgt.controller.OPSView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(OPSView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
